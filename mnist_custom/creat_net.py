...
base_root='/home/dana/caffe_wds/mnist_custom'
...
def creat_train_net(batch_size):
    n=caffe.NetSpec()
    n.data=L.Input(shape=[dict(dim=[batch_size,3,28,28])])
...
with open(train_net,'w') as f:
    f.write(str(creat_train_net(64)))
with open(test_net,'w') as f:
    f.write(str(creat_test_net(100)))
